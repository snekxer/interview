    ...
    <nav class="navbar navbar-fixed-top opaque-navbar mobile-navbar box-shadow-gray">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo" src="/resources/img/logo.png" alt="logo Interview"></a>
            </div>
       ...
       <?php    } ?> 
        ...
        <div id="sidebar" style="height:100%;width:400px;background-color:rgb(217, 217, 217);position:fixed!important;z-index:1;overflow:auto;right: 0;display: none">
            ...
            <form action="postulaciones/postulaciones_ofertas.php" id="formFiltros" method="post">
            <div class="panel-group" id="accordion">
                    ...
                    <div id="collapse1" class="panel-collapse collapse in">
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="genero" value="I">Indistinto
                                </label>
                            </div>
                    ...
                    <div id="collapse2" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select name="nivel_educacion" class="form-control" required>
                                <?php
                    ...
                    <div id="collapse3" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select name="area_experiencia" class="form-control" required>
                                <?php
                    ...
                    <div id="collapse4" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select name="asp_salarial" class="form-control" required>
                                <?php
                ...
                <button  id="filtrar" class="btn el-border el-border-azure-radiant bg-white">Filtrar</button>
