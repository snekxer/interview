 ...
 */
    ...
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Mensajes/Mensajes_Emprendedor.php";
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Ofertas/Ofertas_Global.php";
    ...
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Perfiles/Emprendedor/Emprendedor_Emprendedor.php";
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Portafolio/Portafolio_Global.php";
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Productos/Productos_Emprendedor.php";
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Servicios/Servicios_Emprendedor.php";
    include $_SERVER['DOCUMENT_ROOT']."/data/Functions/Trayectoria/Trayectoria_Emprendedor.php";